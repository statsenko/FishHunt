...
[ExecuteInEditMode]
[AddComponentMenu("MYGUI/UI/Root")]
public class MYRoot : MonoBehaviour
{
	static List<MYRoot> mRoots = new List<MYRoot>();

	/// <summary>
	/// List of all UIRoots present in the scene.
	/// </summary>

	static public List<MYRoot> list { get { return mRoots; } }
	...
	//[System.Obsolete("Use Root's scalingStyle property instead")]
	...
	{
		Root root = NGUITools.FindInParents<Root>(go);

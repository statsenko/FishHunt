...
public class UIScrollBar : MonoBehaviour
{
	...
	[HideInInspector][SerializeField] MYSprite mBG;
	[HideInInspector][SerializeField] MYSprite mFG;
	...
	public MYSprite background { get { return mBG; } set { if (mBG != value) { mBG = value; mIsDirty = true; } } }

	/// <summary>
	/// Sprite used for the foreground.
	/// </summary>

	public MYSprite foreground { get { return mFG; } set { if (mFG != value) { mFG = value; mIsDirty = true; } } }
	...
	public void ForceUpdate ()
	{
		...
		if (mBG != null && mFG != null)
		{
			...
			if (mDir == Direction.Horizontal)
			{
				...
				mFG.pivot = MYWidget.Pivot.Left;
				mBG.pivot = MYWidget.Pivot.Left;
			...
			else
			{
				...
				mFG.pivot = MYWidget.Pivot.Top;
				mBG.pivot = MYWidget.Pivot.Top;
				mBG.cachedTransform.localPosition = Vector3.zero;

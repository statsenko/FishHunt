...
/// <summary>
/// MYFont contains everything needed to be able to print text.
/// </summary>

[ExecuteInEditMode]
[AddComponentMenu("MYGUI/UI/Font")]
public class MYFont : MonoBehaviour
{
	...
	[HideInInspector][SerializeField] MYFont mReplacement;
	...
	void Trim ()
	{
		...
		if (tex != null && mSprite != null)
		{
			...
			Rect trimmed = (mAtlas.coordinates == MYAtlas.Coordinates.TexCoords) ?
	...
	static public bool CheckIfRelated (MYFont a, MYFont b)
	{

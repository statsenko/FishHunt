...
[ExecuteInEditMode]
[AddComponentMenu("MYGUI/UI/Sprite")]
public class MYSprite : MYWidget
{
	public enum Type
	{
		Simple,
	...
	[HideInInspector][SerializeField] MYAtlas mAtlas;
	...
	protected MYAtlas.Sprite mSprite;
	...
	public string spriteName
	{
		...
		set
		{
			...
			else if (mSpriteName != value)
			{
				...
				// MY CODE!!!!!!!!!!!
				//if (sr.material  == null || sr.material !=  material)
					sr.material =  material;
				LoadSpritesFromSpritesheet();
				sr.sprite = GetSpriteByName(mSpriteName,spritesArray);
	...
	//http://answers.unity3d.com/questions/603428/unity3d-43-get-sprite-from-atlas.html
	...
	public override Vector4 border
	{
		get
		{
			...
			{
				MYAtlas.Sprite sp = GetAtlasSprite();
				...
				if (atlas.coordinates == MYAtlas.Coordinates.TexCoords && tex != null)
				{
	...
	public MYAtlas.Sprite GetAtlasSprite ()
	{
		...
		if (mSprite == null && mAtlas != null)
		{
			if (!string.IsNullOrEmpty(mSpriteName))
			{
				MYAtlas.Sprite sp = mAtlas.GetSprite(mSpriteName);
			...
			{
				MYAtlas.Sprite sp = mAtlas.spriteList[0];
				if (sp == null) return null;
				SetAtlasSprite(sp);
	...
	protected void SetAtlasSprite (MYAtlas.Sprite sp)
	{
		mChanged = true;
		mSpriteSet = true;
	...
	virtual public void UpdateUVs (bool force)
	{
			...
			))
		{
			...
			if (tex != null)
			{
				...
				if (atlas.coordinates == MYAtlas.Coordinates.Pixels)
				{
...
//!!!		colF.a *= mPanel.alpha;
	...
	protected void TiledFill (BetterList<Vector3> verts, BetterList<Vector2> uvs, BetterList<Color32> cols)
	{
		...
		if (atlas.coordinates == MYAtlas.Coordinates.TexCoords)
		{

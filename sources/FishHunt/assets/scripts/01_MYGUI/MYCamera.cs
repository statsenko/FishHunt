...
[ExecuteInEditMode]
[AddComponentMenu("MYGUI/UI/Camera")]
...
public class MYCamera : MonoBehaviour
{
	...
	static public MYCamera current = null;
	...
	static List<MYCamera> mList = new List<MYCamera>();
	...
	static public GameObject selectedObject
	{
		...
		set
		{
			if (mSel != value)
			{
				if (mSel != null)
				{
					MYCamera uicam = FindCameraForLayer(mSel.layer);
	...
	static public MYCamera eventHandler
	{
		get
		{
	...
	static int CompareFunc (MYCamera a, MYCamera b)
	{
	...
	static public MYCamera FindCameraForLayer (int layer)
	{
	...
	static bool LoadingOrAlertDisablingEvents(MYCamera cam)
	{

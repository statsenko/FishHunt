...
[AddComponentMenu("MYGUI/UI/Atlas")]
public class MYAtlas : MonoBehaviour
{
	// Ideally this class should be called UISpriteData and should be separate from MYAtlas...
	...
	[HideInInspector][SerializeField] MYAtlas mReplacement;
	...
	static public bool CheckIfRelated (MYAtlas a, MYAtlas b)
	{
	...
	public void MarkAsDirty ()
	{
		...
		MYSprite[] list = NGUITools.FindActive<MYSprite>();
		...
		MYFont[] fonts = Resources.FindObjectsOfTypeAll(typeof(MYFont)) as MYFont[];

...
public class UIScrollBarInspector : Editor
{
	public override void OnInspectorGUI ()
	{
		...
		MYSprite bg = (MYSprite)EditorGUILayout.ObjectField("Background", sb.background, typeof(MYSprite), true);
		MYSprite fg = (MYSprite)EditorGUILayout.ObjectField("Foreground", sb.foreground, typeof(MYSprite), true);

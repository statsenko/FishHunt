...
public class MYFontInspector : Editor
{
	enum View
	{
		Nothing,
	...
	void OnSelectFont (MonoBehaviour obj)
	{
		...
		mFont.replacement = obj as MYFont;
	...
	void MarkAsChanged ()
	{
		...
		{
			if (MYFont.CheckIfRelated(lbl.font, mFont))
			{
				lbl.font = null;
				lbl.font = mFont;
			}
	...
	public override void OnInspectorGUI ()
	{
		...
		{
			ComponentSelector.Draw<MYFont>(mFont.replacement, OnSelectFont);
		...
		else
		{
			...
			ComponentSelector.Draw<MYAtlas>(mFont.atlas, OnSelectAtlas);

...
public class NGUIEditorTools
{
	...
	static public GameObject SelectedRoot (bool createIfMissing)
	{
		...
		*/
		///!!!
		GameObject go = Selection.activeGameObject;
		MYRoot root = (go != null) ? NGUITools.FindInParents<MYRoot>(go) : null;
	...
	static public string GetSaveableTexturePath (MYAtlas atlas)
	{
	...
	static public void SpriteField (string fieldName, MYAtlas atlas, string spriteName,
	...
	static public void SpriteField (string fieldName, MYAtlas atlas, string spriteName, SpriteSelector.Callback callback)
	{
	...
	static public void SpriteField (string fieldName, string caption, MYAtlas atlas, string spriteName, SpriteSelector.Callback callback)
	{
		GUILayout.BeginHorizontal();
		GUILayout.Label(fieldName, GUILayout.Width(76f));
	...
	static public bool SimpleSpriteField (MYAtlas atlas, string spriteName, SpriteSelector.Callback callback, params GUILayoutOption[] options)
	{
		if (atlas.GetSprite(spriteName) == null)
			spriteName = "";
	...
	static public void AdvancedSpriteField (MYAtlas atlas, string spriteName, SpriteSelector.Callback callback, bool editable,
		params GUILayoutOption[] options)
	{
		...
		GUILayout.BeginHorizontal();
		{
			...
			if (editable)
			{
				...
				if (sn != spriteName)
				{
					MYAtlas.Sprite sp = atlas.GetSprite(spriteName);
	...
	static public bool IsUniform (GameObject go)
	{
		...
		if (go.GetComponent<MYWidget>() != null)
		{
	...
	static public void FixUniform (GameObject go)
	{
		...
		while (t != null && t.gameObject.GetComponent<MYRoot>() == null)
		{
